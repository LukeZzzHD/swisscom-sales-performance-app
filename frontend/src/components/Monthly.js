...
class Monthly extends Component {
    ...
    componentDidMount() {
        //fetch Monthly data from backend api with axios
    }
        ...
        return (
            <div className='box salesguy'>
                ...
                <div className='tnps-stats'>
                    ...
                    <div>
                        My Service Abo: <div className='inp-values total-monthly-value-msabo'>{myServiceAboValue}</div>
                    </div>
                    <div>
                        Protection Plus:{' '}
                        <div className='inp-values total-monthly-value-pplus'>{protectionPlusValue}</div>
                    </div>
                </div>
            </div>
        );
