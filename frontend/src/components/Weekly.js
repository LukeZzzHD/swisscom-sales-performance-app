        ...
        return (
            <div className='box salesguy'>
                    ...
                    <div className='bar-chart-horizontal bar-chart-horizontal--limited'>
                        ...
                        <div className='bar-chart__progress'>
                            <div
                                ...
                                <div className='indicator' style={{ backgroundColor: 'rgb(37, 178, 82)' }}></div>
                            </div>
                        </div>
                ...
                <div className='tnps-stats'>
                    ...
                    <div>
                        My Service Abo: <div className='inp-values total-weekly-value-msabo'>{myServiceAboValue}</div>
                    </div>
                    <div>
                        Protection Plus:
                        <div className='inp-values total-weekly-value-pplus'>{protectionPlusValue}</div>
                    </div>
                </div>
            </div>
        );
